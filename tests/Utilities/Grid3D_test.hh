...
class MockGrid3D : public Grid3D {
    public:
        // Mock Add point
        MOCK_METHOD4(AddPoint,void(const size_t&, const size_t&, const size_t&, const double&));
        MOCK_METHOD4(AddPoint,void(const double&, const double&, const double&, const double&));
        ...
        MOCK_CONST_METHOD1(FindZ,std::vector<double>::const_iterator(const double&));
        MOCK_CONST_METHOD3(FindPoint, double(const size_t&, const size_t&, const size_t&));
        MOCK_CONST_METHOD3(FindPoint, double(const double&, const double&, const double&));
        MOCK_CONST_METHOD3(FindPointLocation, size_t(const double&, const double&, const double&));

        // Mock Getters
        MOCK_CONST_METHOD1(GetX, double(const size_t&));
        MOCK_CONST_METHOD1(GetY, double(const size_t&));
        MOCK_CONST_METHOD1(GetZ, double(const size_t&));
        MOCK_CONST_METHOD0(GetXDim, size_t());
        MOCK_CONST_METHOD0(GetYDim, size_t());
        MOCK_CONST_METHOD0(GetZDim, size_t());

        // Mock Interpolation
        MOCK_METHOD6(Interpolate, double(const double&, const double&, const double&,
