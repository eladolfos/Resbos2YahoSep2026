#ifndef DELTASIGMA_TEST_HH
#define DELTASIGMA_TEST_HH
...
class DeltaSigmaTest : public ::testing::Test {
    protected:
        ...
        std::unique_ptr<ResBos::Calculation> DeltaSigmaCSS, DeltaSigmaCFG;
