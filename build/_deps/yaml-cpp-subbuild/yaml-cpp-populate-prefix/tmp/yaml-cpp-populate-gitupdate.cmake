...
execute_process(
  COMMAND "/usr/bin/git" --git-dir=.git show-ref "4edff1fa5dbfca16fc72d89870841bee89f8ef89"
  WORKING_DIRECTORY "/mnt/home/fuyao3/pku_resbos/SourceCode/resbos2/build/_deps/yaml-cpp-src"
...
if(show_ref_output MATCHES "^[a-z0-9]+[ \\t]+refs/remotes/")
  ...
  set(checkout_name "4edff1fa5dbfca16fc72d89870841bee89f8ef89")
...
elseif(show_ref_output MATCHES "^[a-z0-9]+[ \\t]+refs/tags/")
  ...
  get_hash_for_ref("4edff1fa5dbfca16fc72d89870841bee89f8ef89" tag_sha error_msg)
...
elseif(show_ref_output MATCHES "^[a-z0-9]+[ \\t]+refs/heads/")
  ...
  set(checkout_name "origin/4edff1fa5dbfca16fc72d89870841bee89f8ef89")
  ...
  elseif(tag_sha STREQUAL "")
    ...
    if(NOT can_fetch)
      message(FATAL_ERROR
        "Requested git ref \"4edff1fa5dbfca16fc72d89870841bee89f8ef89\" is not present locally, and not "
...
if(git_update_strategy STREQUAL "CHECKOUT")
  ...
  if(error_code)
    ...
    if(NOT git_update_strategy STREQUAL "REBASE_CHECKOUT")
      ...
      message(FATAL_ERROR "\nFailed to rebase in: '/mnt/home/fuyao3/pku_resbos/SourceCode/resbos2/build/_deps/yaml-cpp-src'."
...
if(need_stash)
  ...
  if(error_code)
    ...
    if(error_code)
      ...
      message(FATAL_ERROR "\nFailed to unstash changes in: '/mnt/home/fuyao3/pku_resbos/SourceCode/resbos2/build/_deps/yaml-cpp-src'."
                          "\nYou will have to resolve the conflicts manually")
    endif()
  endif()
endif()
