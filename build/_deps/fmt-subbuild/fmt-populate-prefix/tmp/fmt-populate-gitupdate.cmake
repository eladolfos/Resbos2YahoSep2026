...
execute_process(
  COMMAND "/usr/bin/git" --git-dir=.git show-ref "63479c8519c7fa3571707ec7f40b87438b9b9c51"
  WORKING_DIRECTORY "/mnt/home/fuyao3/pku_resbos/SourceCode/resbos2/build/_deps/fmt-src"
...
if(show_ref_output MATCHES "^[a-z0-9]+[ \\t]+refs/remotes/")
  ...
  set(checkout_name "63479c8519c7fa3571707ec7f40b87438b9b9c51")
...
elseif(show_ref_output MATCHES "^[a-z0-9]+[ \\t]+refs/tags/")
  ...
  get_hash_for_ref("63479c8519c7fa3571707ec7f40b87438b9b9c51" tag_sha error_msg)
...
elseif(show_ref_output MATCHES "^[a-z0-9]+[ \\t]+refs/heads/")
  ...
  set(checkout_name "origin/63479c8519c7fa3571707ec7f40b87438b9b9c51")
  ...
  elseif(tag_sha STREQUAL "")
    ...
    if(NOT can_fetch)
      message(FATAL_ERROR
        "Requested git ref \"63479c8519c7fa3571707ec7f40b87438b9b9c51\" is not present locally, and not "
...
if(git_update_strategy STREQUAL "CHECKOUT")
  ...
  if(error_code)
    ...
    if(NOT git_update_strategy STREQUAL "REBASE_CHECKOUT")
      ...
      message(FATAL_ERROR "\nFailed to rebase in: '/mnt/home/fuyao3/pku_resbos/SourceCode/resbos2/build/_deps/fmt-src'."
...
if(need_stash)
  ...
  if(error_code)
    ...
    if(error_code)
      ...
      message(FATAL_ERROR "\nFailed to unstash changes in: '/mnt/home/fuyao3/pku_resbos/SourceCode/resbos2/build/_deps/fmt-src'."
                          "\nYou will have to resolve the conflicts manually")
    endif()
  endif()
endif()
